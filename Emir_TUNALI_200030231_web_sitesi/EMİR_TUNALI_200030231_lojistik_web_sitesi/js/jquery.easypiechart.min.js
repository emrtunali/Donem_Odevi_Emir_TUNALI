 ...
 * Bir tuval öğesi oluşturur ve tuval üzerine pasta grafiği çizmek için JavaScript'i kullanır.
 *  Eklenti, grafiğin renklerinin, boyutunun, dönüşünün ve animasyonunun özelleştirilmesine olanak tanır.
 *  Ayrıca, animasyon başladığında, durduğunda veya adım attığında işlevleri ve geri aramaları kolaylaştırmak için seçenekler içerir. 
 * Eklenti çağrılarak kullanılabilir.
kolayPieChart
  bir jQuery nesnesinde işlev.
 *
 * @license
