 ...
 * Bu kod, onu desteklemeyen tarayıcılar için girdi ve metin alanı öğelerinde HTML5 yer tutucu özniteliği için bir geri dönüş sağlayan bir jQuery eklentisidir. 
 * Girdi veya textarea öğesine özel bir sınıf ekler ve değerini yer tutucu metne ayarlar.
 *  Öğe odaklandığında, yer tutucu metin kaldırılır ve odağı kaybettiğinde ve hiçbir değeri kalmadığında, yer tutucu metin geri yüklenir.
 *  Eklenti, aynı niteliklere sahip bir metin giriş alanı oluşturarak ve şifre alanını gizleyerek şifre giriş alanlarını da yönetir. 
 * Metin giriş alanına odaklanıldığında, şifre alanı ile değiştirilir.
 *  Eklenti ayrıca, herhangi bir yer tutucu değerini silmek için form gönderme ve pencere boşaltma için olay işleyicileri içerir.
 */
!(function (a) {
