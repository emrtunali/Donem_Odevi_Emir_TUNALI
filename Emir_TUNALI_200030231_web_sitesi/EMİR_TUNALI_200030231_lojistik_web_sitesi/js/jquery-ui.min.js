/*! 
 * 
 * "Sekmeler" widget'ı, her sekmenin farklı bir içerik paneli görüntülediği sekmeli bir arayüz oluşturur.
 *  Sekme eklemek ve kaldırmak, belirli bir sekmeyi seçmek ve AJAX yoluyla içerik yüklemek için yöntemler sağlar.

"araç ipucu" widget'ı, kullanıcı fareyi bir öğenin üzerine getirdiğinde ek bilgileri görüntüleyen bir araç ipucu oluşturur.
 Araç ipucunun özel içeriğine, konumlandırılmasına ve stiline izin verir.
  Araç ipucu, mouseover veya focusin gibi çeşitli olaylarla tetiklenebilir ve mouseleave veya focusout gibi olaylarla kapatılabilir.

Her iki pencere öğesi de özelleştirilebilen ve çağrılabilen çeşitli seçeneklere ve yöntemlere sahiptir. */
