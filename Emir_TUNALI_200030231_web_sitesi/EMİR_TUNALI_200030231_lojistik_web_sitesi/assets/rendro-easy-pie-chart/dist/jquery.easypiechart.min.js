 ...
 * 
 * 
 *Bu kod, basit, animasyonlu ve retina için optimize edilmiş pasta grafiklerin oluşturulmasına izin veren bir jQuery eklentisidir.
  Bir tuval öğesi oluşturur ve tuval üzerine pasta grafiği çizmek için JavaScript'i kullanır. Eklenti, pasta grafiğin renkler, boyut ve animasyon süresi gibi çeşitli yönlerinin özelleştirilmesine olanak tanır. Eklenti ayrıca animasyon için kolaylaştırma işlevleri ve animasyon başladığında,
  durduğunda ve adım attığında geri aramalar içerir. Eklenti, bir jQuery nesnesinde "easyPieChart" işlevi çağrılarak kullanılabilir.
 * @license
